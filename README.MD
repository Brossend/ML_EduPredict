...
Проведён полный EDA с визуализацией, проверкой гипотез и созданием новых признаков.
...
* Выполнен baseline (+2)
* Сравнено 5 разных семейств моделей (+6)
* Применена Optuna (50 trials) → +3 балла
* Проведён честный анализ trade-off качество/время → +5 баллов
...
Лучший результат: 0.79450 на 5-fold CV (Optuna, trial 1)
